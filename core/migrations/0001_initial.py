# Generated by Django 6.0.4 on 2026-05-23 04:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('activo', models.IntegerField(blank=True, null=True)),
                ('id_especialidad', models.ForeignKey(blank=True, db_column='id_especialidad', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='core.especialidades')),
            ],
            options={
                'db_table': 'doctores',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_doctor', models.ForeignKey(blank=True, db_column='id_doctor', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='core.doctores')),
                ('id_estado_cita', models.ForeignKey(blank=True, db_column='id_estado_cita', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='core.estadoscita')),
                ('id_motivo_consulta', models.ForeignKey(blank=True, db_column='id_motivo_consulta', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='core.motivosconsulta')),
                ('id_paciente', models.ForeignKey(blank=True, db_column='id_paciente', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='core.pacientes')),
            ],
            options={
                'db_table': 'citas',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_cita', models.ForeignKey(blank=True, db_column='id_cita', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='core.citas')),
                ('id_doctor', models.ForeignKey(blank=True, db_column='id_doctor', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='core.doctores')),
                ('id_paciente', models.ForeignKey(blank=True, db_column='id_paciente', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='core.pacientes')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_cita', models.ForeignKey(blank=True, db_column='id_cita', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='core.citas')),
                ('id_paciente', models.ForeignKey(blank=True, db_column='id_paciente', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='core.pacientes')),
                ('id_tipo_pago', models.ForeignKey(blank=True, db_column='id_tipo_pago', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='core.tipospago')),
            ],
            options={
                'db_table': 'pagos',
            },
        ...
        migrations.AddField(
            model_name='doctores',
            name='id_usuario',
            field=models.ForeignKey(blank=True, db_column='id_usuario', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='core.usuarios'),
        ),
        migrations.AddField(
            model_name='citas',
            name='creada_por',
            field=models.ForeignKey(blank=True, db_column='creada_por', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='core.usuarios'),
        ),
        migrations.CreateModel(
            name='Auditoria',
            fields=[
